...
if __name__ == "__main__":
    ...
    with open("../data/smiles.txt", "r") as f:
        lines = f.readlines()
        for line in tqdm(lines, desc="Processing SMILES", unit="line"):
            line = line.strip('\n')
            # print(line)
            try:
                mol = MolTree(line)
    ...
    with open("../data/error_smiles.txt", "w") as f:
        for item in error_smiles:
            f.write(item)
            f.write('\n')
    
    clique_list = list(cset)
    with open('../data/clique.txt', 'w') as file:
        for c in clique_list:
            file.write(c)
            file.write('\n')

    input_file = '../data/clique.txt'
    output_file = '../data/clique.json'
    ...
    print(f"Completion! The file has been saved as: {output_file}")